...
namespace EFAndLinqPractice_SchoolAPI.IoC
{
    public static class DependencyContainer
    {
        public static IServiceCollection AddSqlDatabaseAsDataSource(this IServiceCollection services, string connectionString)
        {
